...
import { CONTACT } from '../../consts/data';
...
function ContactForm() {
    ...
    return (
        ...
        <motion.form
            ...
            className='text-black max-w-md mx-auto mt-10 p-6 text-darkblue-100 bg-transparent shadow-md rounded-md border'
        >
...
function Contact() {
    return (
        <div id='contact' className='pb-20 p-10'>
            <motion.h1
                whileInView={{ opacity: 1, y: 0 }}
                initial={{ opacity: 0, y: -100 }}
                transition={{ duration: 1.5 }}
